...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "JOBS ÉTUDIANTS — Université de Lomé · Étudier, servir, gagner dignement" },
      { name: "description", content: "Plateforme officielle des jobs étudiants d'entretien et d'assainissement à l'Université de Lomé. Inscrivez-vous, participez et gagnez." },
      { name: "author", content: "Université de Lomé" },
